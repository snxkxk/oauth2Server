...
<em>授权协议：<a href="http://www.batgm.com/tree/master/LICENSE">GPL-2.0</a></em>
...
<strong>MySQL版本请访问Branch: <a href="http://www.batgm.com/">master</a></strong>
<br/>
<strong>MongoDB版本请访问Branch: <a href="http://www.batgm.com/tree/mongodb/">mongodb</a></strong>
<hr/>
<h3>
...
<li>
<a href="http://www.batgm.com/repository/archive?ref=master">下载</a>(或clone)项目到本地
</li>
<li>
...
<li>
参考<a href="http://www.batgm.com/blob/master/others/oauth_test.txt">oauth_test.txt</a>(位于others目录)的内容并测试之(也可在浏览器中访问相应的地址,如: http://localhost:8080/spring-oauth-server).
</li>
</ol>
</p>
...
<li>
<p>
 如果在使用过程中遇到特殊的问题(如:如何将oauth_code存入数据库),请访问项目的 <a href="http://www.batgm.com/wikis/pages">Wiki</a> 
 与 <a href="http://www.batgm.com/attach_files">附件</a>. 
 <br/>
 我会把大家反馈的问题解决办法添加在这里.
 <br/>
 若在这两个地方没有找到解决办法的,
 欢迎发邮件到<a href="mailto:snxkxk@foxmail.com">snxkxk@foxmail.com</a>一起讨论.
</p>
</li>

<li>
<p>
 如果在使用项目的过程中发现任何的BUG或者更好的提议, 建议将其提交到项目的 <a href="http://www.batgm.com/issues">Issues</a> 中, 
 我会一直关注并不断改进项目. 
</p>
</li>
</ol>
...
<p>
    <ol>
        ...
        <li><p><em>2013-11-20</em>     发布<a href="http://www.batgm.com/tree/0.1/">0.1</a>版本</p></li>
        ...
        <li><p><em>2015-06-07</em>        发布<a href="http://www.batgm.com/tree/0.3/">0.3</a>版本</p></li>
        <li><p>
        ...
        <li><p><em>2015-11-18</em>        发布 <a href="http://www.batgm.com/tree/0.4-beta/">0.4-beta</a> 版本</p></li>
        <li><p><em>2016-01-02</em>        发布 <a href="http://www.batgm.com/tree/0.4/">0.4</a> 版本</p></li>
        <li><p><em>2016-02-19</em>        Add 0.5 version development planning</p></li>
        <li><p><em>2016-04-03</em>        Add <a href="http://www.batgm.com/tree/config/">config</a> branch</p></li>
        <li><p><em>2016-04-14</em>        Add <a href="http://www.batgm.com/tree/mongodb/">mongodb</a> branch</p></li>
        <li><p><em>2018-04-21</em>        使用spring-boot重构,增加2.0.0实现 <a href="http://www.batgm.com/tree/2.0.0/">2.0.0</a> </p></li>
        <li><p><em>2018-05-01</em>        开始 <a href="http://www.batgm.com/tree/config/">2.0.1</a> 分支开发</p></li>
        <li><p><em>2019-07-04</em>        Add Redis <a href="http://www.batgm.com/tree/config-redis/">config</a> branch</p></li>
    </ol>
</p>
